...
def convert_via_libreoffice(input_path, output_folder):
    ...
    # This replaces the Windows-only comtypes/pythoncom logic
    subprocess.run([
...
def convert_api():
    try:
        ...
        # ---------- LINUX COMPATIBLE CONVERSION LOGIC ----------
        ...
        # Word, PPT, and Excel all use LibreOffice on Render
            ...
            # Poppler is found automatically on Render
